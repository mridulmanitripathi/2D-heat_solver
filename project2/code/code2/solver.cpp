...
#pragma omp parallel for default(shared) firstprivate(elem,M,F,K,TL,MTnewL)                              // parallelizing using atomic memory access
...
#pragma omp parallel for default(shared) firstprivate(pNode,massTmp,MT,Tnew,T)                                  // parallelizing using atomic memory access
